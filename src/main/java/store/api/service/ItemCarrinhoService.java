...
public class ItemCarrinhoService {
    ...
    private final ProdutoRepository mercadoriaRepository;
    private final UsuarioRepository usuarioRepository;
    private final ItemCarrinhoRepository itemCarrinhoRepository;


    public ItemCarrinhoService(ProdutoRepository mercadoriaRepository1, UsuarioRepository usuarioRepository, ItemCarrinhoRepository mercadoriaRepository) {
    ...
    public List<ItemCarrinho> create(ListaCarrinhoDto dadosCompra) throws StoreException {
        ...
        try {
            ...
            for (ItemCarrinhoRequestDto compra : dadosCompra.getCompras()) {
                ...
                Produto mercadoria = mercadoriaRepository.findById(compra.getId().longValue()).get();
